...
//                }
         ...
         */
         // 160920 추가 : parameter customContents 추가
        popupLodingByData: function (url, callbackConfirm, callbackCancel, popupClass, customContents) {
            // 전체 팝업을 담는  컨테이너 생성
            if ($("#popupContainer").length == 0) {
                $("body").append('<div id="popupContainer"></div>');
            }
            ...
            if($("#div_ajax_load_image").length != 0) {
                   ...
                   $('body').append('<div id="div_ajax_load_image" style="position:absolute; top:' + top + 'px; left:' + left + 'px; width:' + width + 'px; height:' + height + 'px; z-index:9999; background:#f0f0f0; filter:alpha(opacity=50); opacity:alpha*0.5; margin:auto; padding:0; "><img src="http://img.nepamall.com/resources/images/stypoint/lodingbar.gif" style="width:50px; height:50px;"></div>');
            }*/
