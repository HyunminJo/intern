...
<div class="table-form-wrap">
	<form name="searchForm"
		action=${popupYn eq 'Y' ? "/sample/freeBoardList/popup" : "/sample/freeBoardList"}
		method="get">
...
<div class="table-list-wrap">
				...
				<tr>
					...
					<td><c:choose>
							<c:when test="${popupYn ne 'Y'}">
								<a
									href="/sample/freeBoardFormMod?boardArtclSeq=${board.boardArtclSeq}&searchData=<core:param encode="true" />"><c:out
	...
	<div class="table-footer">
		...
		<c:if test="${popupYn ne 'Y' }">
			<div class="btn-wrap">
				<button type="button" class="btn btn-primary"
					onclick="location.href='/sample/freeBoardFormReg';">등록</button>
			</div>
		</c:if>
	</div>
</div>
